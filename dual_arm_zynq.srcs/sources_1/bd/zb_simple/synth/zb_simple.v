...
//Date        : Wed May 27 21:31:51 2020
//Host        : parallels-Parallels-Virtual-Platform running 64-bit Ubuntu 18.04.4 LTS
//Command     : generate_target zb_simple.bd
//Design      : zb_simple
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "zb_simple,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=zb_simple,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "zb_simple.hwdef" *) 
module zb_simple
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  zb_simple_processing_system7_0_0 processing_system7_0
