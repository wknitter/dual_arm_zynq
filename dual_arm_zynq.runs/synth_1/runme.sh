...
HD_PWD='/home/parallels/dual_arm_zynq/dual_arm_zynq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zb_simple_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zb_simple_wrapper.tcl
