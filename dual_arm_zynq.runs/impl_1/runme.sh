...
HD_PWD='/home/parallels/dual_arm_zynq/dual_arm_zynq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zb_simple_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zb_simple_wrapper.tcl -notrace
